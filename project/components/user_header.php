...
<header class="header">
   ...
   <nav class="navbar nav-1">
      <section class="flex">
         <a href="home.php" class="logo"><i class="fas fa-house"></i>IntelligentHome</a>
   ...
   <nav class="navbar nav-2">
      <section class="flex">
         ...
         <ul>
            ...
            <li><a href="#" class="signup-button" style="color: black;">Profile <i class="fas fa-angle-down"></i></a>
               <ul class="dropdown">
                  <li><a href="update.php">Update Profile</a></li>
                  <li><a href="components/user_logout.php" onclick="return confirm('logout from this website?');">Log Out</a></li>
               </ul>
            </li>
         </ul>
      </section>
